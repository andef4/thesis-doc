...
Methods
    ...
    how and why did we select those?
    RISE
    LIME
    Grad-CAM
...
Classification
    ...
    The NHS-Chest X-ray dataset
    Training
    Applying RISE (and commenting what is good/bad)
    Applying LIME (and commenting what is good/bad)
    Applying Grad-CAM (and commenting what is good/bad)
...
\include{chapters/nih-chest-x-ray}
\include{chapters/methods}
\include{chapters/brats_preprocess.tex}
