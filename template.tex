...
\fancypagestyle{plain}{												% new definition of plain style	
	\fancyfoot[OR,L]{\footnotesize \thepage} 	% footer right part --> page number
	\fancyfoot[OL,R]{\footnotesize \heading, Version \versionnumber, \versiondate}	% footer even page left part 
}
