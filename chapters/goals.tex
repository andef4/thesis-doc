...
vgrid,
hgrid,
milestone/.append style={anchor=east,xshift=-1pt,fill=milestone},
]{9}{26}
    \gantttitle{Calendar weeks 2019}{18} \\
    ...
    \ganttbar[bar/.append style={fill=optionalbar}]{Blackbox methods}{16}{18} \ganttnewline
    \ganttbar[bar/.append style={fill=optionalbar}]{Whitebox methods}{16}{18} \ganttnewline
    \ganttbar{Python library}{20}{20} \ganttnewline
    
    \ganttbar{Finish text}{21}{22} \ganttnewline
