...
Use a basic image classificiation problem from the mediacal imaging field to evaluate algorithms.
\begin{itemize}
    \item Use the NIH chest x-ray dataset
    \item Learn a standard architecture for image classification on th
\end{itemize}
