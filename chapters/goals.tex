...
\section{Planning}
All steps described here are prerequisites for the next step if not marked otherwise. All steps build on the steps before it and cannot be skipped expect when explicitly mentioned.
