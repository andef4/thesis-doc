...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{.45\textwidth}
        ...
        \caption{\large{MRI Scan T1ce modality}}
    \end{subfigure}\hspace{1cm}%
    \begin{subfigure}[t]{.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{chapters/06_hdm/book/1.png}
        \caption{\large{Tumor segment}}
    \end{subfigure}
    \begin{subfigure}[t]{.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{chapters/06_hdm/book/2.png}
        \caption{\large{Important parts of the T1ce modality generated with the HDM method}}
    \end{subfigure}\hspace{1cm}%
    \begin{subfigure}[t]{.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{chapters/06_hdm/book/3.png}
        \caption{\large{Important parts of the FLAIR modality generated with the HDM method}}
    \end{subfigure}
\end{figure}